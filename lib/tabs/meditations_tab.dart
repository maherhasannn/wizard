...
class _MeditationsTabState extends State<MeditationsTab>
  ...
  List<MeditationTrack> _getFilteredTracks() {
    List<MeditationTrack> tracks = MeditationData.getAllTracks();
  ...
  void _playTrack(MeditationTrack track) {
    setState(() {
      _currentTrack = track;
      _isPlaying = true;
      _totalDuration = _parseDuration(track.duration);
